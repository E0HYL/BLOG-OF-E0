...
function(r) {
	...
	r.fn.share = function(t) {
		function n(r, t) {
			...
			e.length && (e.append(e.append('<div class="wechat-qrcode"><h4>' + 'wechat: scan the qrcode' + '</h4><div class="qrcode"></div></div>'), e.find(".qrcode").qrcode({
				render: "image",
				size: 100,
				text: "javascript:;",
		...
		this.each(function() {
			var o = r(".social-share");
			n(o, t);
		})
	}, r(function() {
		r(".social-share").share()
	})
}(jQuery);
